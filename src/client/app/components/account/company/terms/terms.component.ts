...
export class TermsComponent {
     header: string = "Over.ai<br>Terms Of Use"
    lastUpdate: string = "Last Updated December 5, 2016.";
    body: string = ` 1. License Grant: For these terms, the term "Software" shall mean all and any of Over.ai's software distributed throughout
